/**
 * seed/prompts.ts — Default seed data for the Prompts collection.
 * Aligned with: engine-v2/response_synthesizers/
 *
 * Contains both prompt modes (type: 'mode') and query templates (type: 'template').
 */
