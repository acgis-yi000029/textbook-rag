/**
 * BboxOverlay — MinerU bounding-box highlight overlay for PDF pages.
 *
 * Renders a semi-transparent rectangle with a floating citation badge
 * over a specific region of a PDF page.
 *
 * Usage: <BboxOverlay bbox={bbox} pageWidth={w} pageHeight={h} renderedWidth={rw} renderedHeight={rh} />
 */
