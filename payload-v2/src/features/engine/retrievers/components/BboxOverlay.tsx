...
/**
 * retrievers/components/BboxOverlay.tsx
 * Bounding-box overlay for retrieval result highlighting on PDF pages.
 *
 * Aligned with: llama_index.retrievers → engine-v2/retrievers/
 * Migrated from: features/chat/pdf/BboxOverlay.tsx
 */
