/**
 * engine/ingestion/types.ts
 * Aligned with: llama_index.ingestion → engine-v2/ingestion/ → collections/IngestTasks + Chunks
 *
 * Type definitions for ingestion pipeline tasks and their outputs.
 */

// ── Task types matching IngestTasks collection ──────────────────────────────
export type TaskType = 'ingest' | 'vectorize' | 'reindex' | 'full'

// ── Task status matching IngestTasks collection ─────────────────────────────
