 ...
 * Data seeding management page — initialize preset data into Payload collections.
 */
...
const SEED_COLLECTIONS = [
  { slug: 'llms', label: 'LLM Models', icon: Brain, description: '预置 5 个模型配置（Qwen、Llama、DeepSeek、GPT-4o）' },
  { slug: 'prompts', label: 'Prompt Modes', icon: FileText, description: '预置 4 种回答模式（Default、Learning、Analysis、Concise）' },
  { slug: 'prompts', label: 'Query Templates', icon: HelpCircle, description: '预置 4 个问题引导模板（定义、范围、步骤、深入理解）' },
]
    ...
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-1">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">数据初始化 · Engine 同步</p>
        </div>
      </div>
